...
outputfile_VP = "ERA5_cvort_out.txt" #This txt file should contain the list of output cyclonic vorticity path and filenames that will be generated by VariableProcessor \
