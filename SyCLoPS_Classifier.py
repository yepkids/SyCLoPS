...
if __name__ == '__main__':
    ...
    # Note that this option assumes 300/200 hPa data. 250 hPa data is not supported. We will update this section soon to allow for a flexible threshold based on different grid resolutions.
