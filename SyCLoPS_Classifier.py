...
TETrackFile='out_track/ERA5_LPS_Tracks.csv' #The StitchNodes output file in CSV format. Required before running the program.
...
ClassifiedOutFile='classified_track/SyCLoPS_classified.parquet' #Choose the output filename of the final classified dataset.
