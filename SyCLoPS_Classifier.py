...
InputFileName=f'classified_track/SyCLoPS_input_{model_data_name}.parquet' #Choose the SyCLoPS input LPS catalog filename. This file will be generated by the program.
